// Auto-generated - VoiceCloneSpeakersOff.vue
...
<template>
  <div class="w-[480px] bg-white rounded-2xl overflow-hidden shadow-[0_8px_40px_rgba(0,0,0,0.09)]">
    ...
    <div class="flex flex-col gap-3 px-6">
      ...
      <!-- Speaker Warning Card -->
      <div class="flex flex-col gap-3.5 p-4 rounded-xl bg-[#f7f9fe] border border-[#ecedef]">
        <div class="flex gap-2.5 w-full">
          <UIcon name="i-lucide-info" class="w-[18px] h-[18px] text-[#b0b0b0] shrink-0 mt-0.5" />
          <div class="flex flex-col gap-1">
            <span class="text-[13px] font-semibold text-[#202123] font-['Reddit_Sans']">Tip</span>
            <span class="text-xs text-[#979797] font-['Reddit_Sans'] leading-[1.4]">
              Enabling speaker detection will improve cloning accuracy for multi-speaker videos.
            </span>
          </div>
        </div>
      </div>
