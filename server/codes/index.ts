...
import BillingDetailsEmpty from './BillingDetailsEmpty'
import BuyClonesModal from './BuyClonesModal'
import DubbingStudio from './DubbingStudio'
import DubbingStudioContainer from './DubbingStudioContainer'
import DubbingStudioPreview from './DubbingStudioPreview'
...
export const componentCodes: Record<string, string> = {
  ...
  'BillingDetailsEmpty.vue': BillingDetailsEmpty,
  'BuyClonesModal.vue': BuyClonesModal,
  'DubbingStudio.vue': DubbingStudio,
  'DubbingStudioContainer.vue': DubbingStudioContainer,
  'DubbingStudioPreview.vue': DubbingStudioPreview,
